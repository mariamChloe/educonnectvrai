...
class ListeClasseScreen2nd extends StatefulWidget {
  @override
  _ListeClasseScreenState createState() => _ListeClasseScreenState();
}

class _ListeClasseScreenState extends State<ListeClasseScreen2nd> {
  ...
  void remplirListeElevesManuellement() {
    setState(() {
      eleves = [
        {'nom': 'Kwabena', 'prenom': 'Ama'},
        {'nom': 'Kamau', 'prenom': 'Chijioke'},
        {'nom': 'Jalloh', 'prenom': 'Nia'},
        {'nom': 'Osei', 'prenom': 'Kwame'},
        {'nom': 'Nkrumah', 'prenom': 'Zahara'},
        {'nom': 'Onyango', 'prenom': 'Aminata'},
        {'nom': 'Chukwu', 'prenom': 'Obi'},
