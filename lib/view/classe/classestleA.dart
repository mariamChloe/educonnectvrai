...
class ListeClasseScreentleA extends StatefulWidget {
  @override
  _ListeClasseScreenState createState() => _ListeClasseScreenState();
}

class _ListeClasseScreenState extends State<ListeClasseScreentleA> {
  ...
  void remplirListeElevesManuellement() {
    setState(() {
      eleves = [
        ...
        {'nom': 'Adebayo', 'prenom': 'Chinwe'},
        {'nom': 'Okafor', 'prenom': 'Obinna'},
        {'nom': 'Sow', 'prenom': 'Neneh'},
        {'nom': 'Kabongo', 'prenom': 'Tariq'},
        {'nom': 'Moyo', 'prenom': 'Zanele'},
        {'nom': 'Kwame', 'prenom': 'Ayodele'},
        {'nom': 'Kamau', 'prenom': 'Nia'},
