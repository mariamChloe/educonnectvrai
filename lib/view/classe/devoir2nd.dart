...
class Devoir2nd extends StatefulWidget {
  final List<Eleve> eleves;

  Devoir2nd({required this.eleves});

  @override
  _NotePageListState createState() => _NotePageListState();
}

class _NotePageListState extends State<Devoir2nd> {
  ...
  void remplirListeElevesManuellement() {
    setState(() {
      eleves = [
        Eleve(nom: 'Kwabena', prenom: 'Ama', note: ''),
        Eleve(nom: 'Kamau', prenom: 'Chijioke', note: ''),
        Eleve(nom: 'Jalloh', prenom: 'Nia', note: ''),
        Eleve(nom: 'Osei', prenom: 'Kwame', note: ''),
        Eleve(nom: 'Nkrumah', prenom: 'Zahara', note: ''),
        Eleve(nom: 'Onyango', prenom: 'Aminata', note: ''),
        Eleve(nom: 'Chukwu', prenom: 'Obi', note: ''),
