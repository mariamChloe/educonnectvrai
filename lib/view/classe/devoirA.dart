...
class DevoirtleA extends StatefulWidget {
  final List<Eleve> eleves;

  DevoirtleA({required this.eleves});

  @override
  _NotePageListState createState() => _NotePageListState();
}

class _NotePageListState extends State<DevoirtleA> {
  ...
  void remplirListeElevesManuellement() {
    setState(() {
      eleves = [
        ...
        Eleve(nom: 'Adebayo', prenom: 'Chinwe', note: ''),
        Eleve(nom: 'Okafor', prenom: 'Obinna', note: ''),
        Eleve(nom: 'Sow', prenom: 'Neneh', note: ''),
        Eleve(nom: 'Kabongo', prenom: 'Tariq', note: ''),
        Eleve(nom: 'Moyo', prenom: 'Zanele', note: ''),
        Eleve(nom: 'Kwame', prenom: 'Ayodele', note: ''),
        Eleve(nom: 'Kamau', prenom: 'Nia', note: ''),
