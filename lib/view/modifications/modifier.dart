import 'dart:convert';
import 'package:Educonnect/view/home/main.dart';
...
class NotePage extends StatefulWidget {
  ...
  NotePage({required this.eleves});

  @override
  _NotePageListState createState() => _NotePageListState();
}

class _NotePageListState extends State<NotePage> {
  ...
  void initControllers() {
    controllers = List.generate(eleves.length, (index) {
      return TextEditingController(text: eleves[index].note);
    });
  }
  ...
  void remplirListeElevesManuellement() {
    setState(() {
      eleves = [
        Eleve(nom: 'Ouedraogo', prenom: 'Aissatou', note: '12'),
        Eleve(nom: 'Diop', prenom: 'Mamadou', note: '14'),
        Eleve(nom: 'Keita', prenom: 'Aminata', note: '16'),
        Eleve(nom: 'Nkosi', prenom: 'Chinedu', note: '08'),
        Eleve(nom: 'Mensah', prenom: 'Akua', note: '14'),
        Eleve(nom: 'Kamara', prenom: 'Sekou', note: '09'),
        Eleve(nom: 'Chibuike', prenom: 'Ngozi', note: '10'),
        Eleve(nom: 'Adebayo', prenom: 'Chinwe', note: '12'),
        Eleve(nom: 'Okafor', prenom: 'Obinna', note: '11'),
        Eleve(nom: 'Sow', prenom: 'Neneh', note: '20'),
        Eleve(nom: 'Kabongo', prenom: 'Tariq', note: '17'),
        Eleve(nom: 'Moyo', prenom: 'Zanele', note: '18'),
        Eleve(nom: 'Kwame', prenom: 'Ayodele', note: '16'),
        Eleve(nom: 'Kamau', prenom: 'Nia', note: '04'),
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (fetchedData.isNotEmpty) {
          ...
          setState(() {
            eleves = elevesFromDB;
            notes = elevesFromDB.map((eleve) => eleve.note).toList();
          });
        } else {
          setState(() {
                  ...
                  subtitle: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          print(
                              'Note de ${eleves[index].prenom} ${eleves[index].nom}: ${controllers[index].text}');
